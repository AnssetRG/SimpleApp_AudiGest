...
class CargandoArchivos(object):
    def setupUi(self, CargandoArchivos):
        ...
        self.pbr_descarg_archivo = QtWidgets.QProgressBar(CargandoArchivos)
        self.pbr_descarg_archivo.setGeometry(QtCore.QRect(50, 110, 311, 31))
        self.pbr_descarg_archivo.setProperty("value", 0)
        self.pbr_descarg_archivo.setObjectName("pbr_descarg_archivo")
